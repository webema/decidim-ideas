...
module Decidim
  module Ideas
    describe IdeaType, type: :graphql do
      include_context "with a graphql class type"

      let(:model) { create(:idea, online_votes: { "total" => 5 }, offline_votes: { "total" => 3 }) }
      ...
      describe "hashtag" do
        ...
        it "returns the idea' hashtag" do
      ...
      describe "createdAt" do
        ...
        it "returns when the idea was created" do
      ...
      describe "updatedAt" do
        ...
        it "returns when the idea was updated" do
      ...
      describe "publishedAt" do
        ...
        it "returns when the idea was published" do
      ...
      describe "signatureStartDate" do
        ...
        it "returns the signature start date of the idea" do
      ...
      describe "signatureEndDate" do
        ...
        it "returns when the idea signature date ends" do
      ...
      describe "reference" do
        ...
        it "returns the idea' reference" do
      ...
      context "without fields from AuthorInterface" do
        %w(name nickname avatarUrl profilePath badge organizationName deleted).each do |field|
          describe field do
            let(:query) { "{ #{field} }" }
            let(:msg) { "Field '#{field}' doesn't exist on type 'Idea'" }
      ...
      describe "ideaVotesCount" do
        let(:query) { "{ ideaVotesCount }" }

        it "has a ideaVotesCount" do
          expect(response).to include("ideaVotesCount" => model.online_votes_count)
        end
      end

      describe "ideaSupportsCount" do
        let(:query) { "{ ideaSupportsCount }" }

        it "has a ideaSupportsCount" do
          expect(response).to include("ideaSupportsCount" => model.supports_count)
        end
      end
    end
  end
