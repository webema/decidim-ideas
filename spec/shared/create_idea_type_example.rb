...
shared_examples "create an idea type" do
  ...
  describe "call" do
    ...
    describe "when the form is not valid" do
      ...
      it "doesn't create an idea type" do
        expect do
          command.call
        end.not_to change(Decidim::IdeasType, :count)
      end
    end
    ...
    describe "when the form is valid" do
      ...
      it "creates a new idea type" do
        expect do
          command.call
        end.to change(Decidim::IdeasType, :count).by(1)
      end

      it "traces the action", versioning: true do
        expect(Decidim.traceability)
          .to receive(:perform_action!)
          .with(:create, Decidim::IdeasType, user, {})
          .and_call_original
