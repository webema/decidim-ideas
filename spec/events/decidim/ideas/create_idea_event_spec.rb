...
describe Decidim::Ideas::CreateIdeaEvent do
  subject do
  ...
  describe "email_subject" do
    it "is generated correctly" do
      expect(subject.email_subject).to eq("New idea by @#{idea_author.nickname}")
    end
  end

  describe "email_intro" do
    it "is generated correctly" do
      expect(subject.email_intro).to eq("#{idea_author.name} @#{idea_author.nickname}, who you are following, has created a new idea, check it out and contribute:")
    end
  end
  ...
  describe "notification_title" do
    it "is generated correctly" do
      expect(subject.notification_title)
        .to include("The <a href=\"#{resource_path}\">#{idea.title["en"]}</a> idea was created by ")
