...
module Decidim
  module Ideas
    ...
    # Idea types.
    class IdeasFilterFormBuilder < Decidim::FilterFormBuilder
      # Public: Generates a select field with the idea types.
      #
      # name       - The name of the field (usually type_id)
      # collection - A collection of idea types.
      # options    - An optional Hash with options:
      # - prompt   - An optional String with the text to display as prompt.
      #
      # Returns a String.
      def idea_types_select(name, collection, options = {})
